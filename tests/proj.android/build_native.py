...
def copy_resources(app_android_root):
    ...
    # copy resources from Resources folder
    os.mkdir(assets_dir)
    resources_dir = os.path.join(app_android_root, "../Resources")
    if os.path.isdir(resources_dir):
        copy_files(resources_dir, assets_dir)
	
	#copy resources from Resources-gen folder
	resources_gen_dir = os.path.join(app_android_root, "../Resources-gen")
	if os.path.isdir(resources_gen_dir):
		copy_files(resources_gen_dir, assets_dir)
