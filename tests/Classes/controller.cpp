...
Controller g_aTestNames[] = {
    ...
    //
	{ "Actions", [](){return new ActionTestScene(); } },
    { "Dialogs", [](){return new DialogTestScene(); } },
	{ "CCBUtils", [](){ return new CCBUtilsTestScene(); } },
	{ "EmptyTest", [](){return new EmptyTestScene();} },
    { "SoundMusic", [](){return new SoundMusicTestScene();} },
    { "StringResource", [](){return new StringResourceTestScene();} },
    { "Utils", [](){return new UtilsTestScene();} },
    { "ExEditBox", [](){return new ExEditBoxTestScene();} },
    { "ExTextField", [](){return new ExTextFieldTestScene();} },
    { "ExTabView", [](){return new ExTabViewTestScene();} },
    { "ExScrollView", [](){return new ExScrollViewTestScene();} },
};
...
{
    // add close menu
    auto closeItem = MenuItemImage::create(pathClose, pathClose, CC_CALLBACK_1(TestController::closeCallback, this) );
